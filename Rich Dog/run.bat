@echo off
title Rich Dog Bot by @MeoMunDep
color 0A
...
cls
echo =================================================================
echo    Rich Dog BOT SETUP AND RUN SCRIPT by @MeoMunDep
echo =================================================================
echo.
...
if not exist configs.json (
    ...
    echo   "howManyBoosts": 1,>> configs.json
    echo   "referralCode": "kentId6713068747">> configs.json
    echo }>> configs.json
